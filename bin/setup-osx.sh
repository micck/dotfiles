...
## Updated to 'Perv' flavour by Mick on 2015-09-28

### Ask for the administrator password upfront
sudo -v

### Keep-alive: update existing `sudo` time stamp until `setup-osx.sh` has finished
...
defaults write NSGlobalDomain AppleHighlightColor -string "1 0.635 0"
...
### Enable the menu bar dark mode toggle of control-option-command-T
...
### -- disabled because of hidden files where also displayed on the desktop
...
### Increase the size of icons on the desktop and in other icon views -- size was 80
...
#  3: Show application windows  7: Dashboard
...
for app in "Address Book" "Calendar" "Contacts" "cfprefsd" "Dock" "Finder" \
  "Google Chrome" "Google Chrome Canary" "Mail" "Messages" "Opera" "Safari" \
